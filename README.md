...
<p align="center">
  <a href="https://github.com/starlab/starlab/blob/main/LICENSE"><img src="https://img.shields.io/github/license/starlab/starlab?style=flat&color=blue" alt="License" /></a>
  <a href="https://github.com/starlab/starlab/stargazers"><img src="https://img.shields.io/github/stars/starlab/starlab?style=flat" alt="Stars" /></a>
  <a href="https://www.npmjs.com/package/starlab"><img src="https://img.shields.io/npm/v/starlab?style=flat&label=cli" alt="CLI Version" /></a>
  <a href="https://app.codecov.io/gh/starlab/starlab"><img src="https://img.shields.io/codecov/c/github/starlab/starlab?flag=api&label=api%20coverage" alt="API Coverage" /></a>
  <a href="https://github.com/starlab/starlab/commits"><img src="https://img.shields.io/github/last-commit/starlab/starlab?style=flat&label=last%20commit" alt="Last Commit" /></a>
  <a href="https://github.com/starlab/starlab/issues"><img src="https://img.shields.io/github/issues/starlab/starlab?style=flat" alt="Issues" /></a>
  <a href="https://github.com/starlab/starlab/pulls"><img src="https://img.shields.io/github/issues-pr/starlab/starlab?style=flat&label=PRs" alt="Pull Requests" /></a>
</p>
...
StarLab has an official CLI that handles everything — self-hosting, updates, backups, and local development.
...
```bash
npx starlab start       # Start services
npx starlab stop        # Stop services
npx starlab update      # Update to latest version
...
- [Documentation](https://docs.starlab.app) — guides and references
...
- [Submit a bug](https://github.com/starlab/starlab/issues/new?assignees=&labels=bug%2Ctriage&projects=&template=bug.yml&title=%5BBug%5D%3A+)
- [Good first issues](https://github.com/starlab/starlab/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)

## 🔒 Security

We take the security of StarLab and the data entrusted to us seriously. If you discover a vulnerability, please email **security@starlab.app** — do not disclose it publicly until we've had a chance to investigate.
...
See our full [Security Policy](https://starlab.app/security) for details on our practices, scope, and responsible disclosure guidelines.
...
StarLab is made with 💜, from the UI to the features it is carefully designed to make students and teachers lives easier and make education software more enjoyable.

Thank you and have fun using/developing/testing StarLab !
