...
pm2 start server-wrapper.js --cwd /app/web --name starlab-web > /dev/null 2>&1
pm2 start uv --cwd /app/api --name starlab-api -- run app.py
pm2 start node --cwd /app/collab --name starlab-collab -- dist/index.js
