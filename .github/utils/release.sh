...
CHANGELOG_FILE=$(mktemp)
{
  ...
  echo "npx starlab backup"
  echo ""
  echo "# Update to this specific version"
  echo "npx starlab update --version ${VERSION}"
  echo "\`\`\`"
  echo ""
  echo "**Docker image:**"
  echo ""
  echo "\`\`\`bash"
  echo "docker pull ghcr.io/starlab/app:${VERSION}"
  echo "\`\`\`"
  echo ""
