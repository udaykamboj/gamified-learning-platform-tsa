...
from src.db.communities.communities import (Community, CommunityUpdate)
...
from src.services.communities.communities import (get_communities_by_org, get_community, get_community_by_course, get_community_user_rights, update_community)
