        ...
        >
                ...
                <div className="flex-1 flex items-center justify-center px-6 md:px-12 lg:px-20">
                    <div className="w-full max-w-[420px] py-10">
                        {/* Header */}
                        <h1 className="text-[28px] md:text-[32px] font-black text-foreground tracking-tight leading-tight">{t('auth.forgot_password_title')}</h1>
                        <p className="mt-2 text-foreground/45 text-[15px] font-medium">{t('auth.forgot_password_description')}</p>
                        ...
                        <p className="text-center text-sm text-foreground/35 mt-6">
                            <Link href="/login" className="inline-flex items-center gap-2 text-foreground font-semibold hover:underline">
                                <ArrowLeft size={16} />
