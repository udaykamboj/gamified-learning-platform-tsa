...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex min-h-11 items-center justify-center gap-1 rounded-[10px] border border-border bg-muted p-1 text-muted-foreground",
      className
    )}
    {...props}
  />
