          ...
          <div className="space-y-5">
            <div className="flex gap-8">
              <div className="bg-emerald-50 rounded-xl px-5 py-3">
                <p className="sl-telemetry text-emerald-400">{t('analytics.course_analytics.common.total')}</p>
                <p className="text-2xl font-bold text-emerald-600">{totalCompletions}</p>
              </div>
              <div className="bg-gray-50 rounded-xl px-5 py-3">
                <p className="sl-telemetry text-gray-400">{t('analytics.course_analytics.common.peak_day')}</p>
