    ...
    <div className="space-y-5">
      <div className="flex gap-4">
        <div className="bg-indigo-50 rounded-xl px-5 py-3 flex-1">
          <p className="sl-telemetry text-indigo-400">{t('analytics.course_analytics.common.total_views')}</p>
          <p className="text-2xl font-bold text-indigo-600">{totalViews}</p>
        </div>
        <div className="bg-emerald-50 rounded-xl px-5 py-3 flex-1">
          <p className="sl-telemetry text-emerald-400">{t('analytics.course_analytics.common.total_completions')}</p>
          <p className="text-2xl font-bold text-emerald-600">{totalCompletions}</p>
        </div>
        <div className="bg-gray-50 rounded-xl px-5 py-3 flex-1">
          <p className="sl-telemetry text-gray-400">{t('analytics.course_analytics.common.avg_rate')}</p>
        ...
        {lowConversion.length > 0 && (
          <div className="bg-rose-50 rounded-xl px-5 py-3 flex-1">
            <p className="sl-telemetry text-rose-400">{t('analytics.course_analytics.common.needs_attention')}</p>
