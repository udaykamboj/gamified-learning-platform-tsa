          ...
          <div className="space-y-5">
            <div className="flex gap-8">
              <div className="bg-indigo-50 rounded-xl px-5 py-3">
                <p className="sl-telemetry text-indigo-400">{t('analytics.course_analytics.common.views')}</p>
                <p className="text-2xl font-bold text-indigo-600">{totalViews}</p>
              </div>
              <div className="bg-emerald-50 rounded-xl px-5 py-3">
                <p className="sl-telemetry text-emerald-400">{t('analytics.course_analytics.common.enrollments')}</p>
                <p className="text-2xl font-bold text-emerald-600">{totalEnrollments}</p>
              </div>
              <div className="bg-amber-50 rounded-xl px-5 py-3">
                <p className="sl-telemetry text-amber-400">{t('analytics.course_analytics.common.conversion')}</p>
