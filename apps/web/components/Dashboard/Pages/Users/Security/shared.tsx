...
export type OrgSecurityPolicy = {
  ...
  // When off, a central starlab.io session can't carry members into this org.
...
export function SecuritySkeleton() {
  return (
    <div className="sm:mx-10 mx-0 space-y-4">
      <div className="sl-card p-6 animate-pulse space-y-4">
        <div className="h-4 w-48 bg-gray-200 rounded" />
        <div className="h-2 w-full bg-gray-100 rounded-full" />
        <div className="h-3 w-64 bg-gray-100 rounded" />
      </div>
      <div className="sl-card p-6 animate-pulse space-y-3">
        {[0, 1, 2, 3].map((i) => (
