          ...
          <DialogFooter className="shrink-0 px-5 py-3 border-t border-gray-100 flex flex-row justify-end gap-2">
            ...
            {params.addDefCloseButton && (
              <button
                ...
                className="px-4 py-2 text-sm font-medium text-primary-foreground bg-primary rounded-lg hover:bg-primary focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-colors"
              >
                Close
              </button>
            )}
