...
function AccountPurchases({ orgId, orgslug }: AccountPurchasesProps) {
  ...
  if (isLoading) {
    return (
      <div className="sl-card p-12 flex items-center justify-center">
  ...
  if (error) {
    return (
      <div className="sl-card p-8 text-center text-sm text-red-400">
  ...
  return (
    <div className="space-y-5">
      ...
      {enrollments.length === 0 ? (
        <div className="sl-card p-12 flex flex-col items-center justify-center text-center">
