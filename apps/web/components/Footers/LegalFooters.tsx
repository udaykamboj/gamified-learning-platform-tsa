...
// CopyrightFooter — the "© {year} StarLab, Inc." line for app surfaces
...
const TERMS_URL = getPlatformUrl('/terms') || 'https://www.starlab.io/terms'
const PRIVACY_URL = getPlatformUrl('/privacy') || 'https://www.starlab.io/privacy'
  ...
  return (
    <footer className={`w-full py-6 px-6 ${className}`}>
      <div className="flex flex-col sm:flex-row items-center justify-center gap-x-5 gap-y-2 text-[13px] font-medium">
        <p className={base}>
          {t('common.copyright', { defaultValue: '© {{year}} StarLab, Inc.', year })}
        </p>
