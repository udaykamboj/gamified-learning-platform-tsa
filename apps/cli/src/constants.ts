...
export const APP_IMAGE = 'ghcr.io/starlab/app:latest'
export const DEV_IMAGE = 'ghcr.io/starlab/app:dev'
...
export const CONFIG_FILENAME = 'starlab.config.json'

// ── Enterprise Edition ───────────────────────────────────────────────────────
// EE images are pulled from the license-gated registry; the license key is the
// docker-login password.
export const EE_REGISTRY = 'images.starlab.app'
export const EE_REGISTRY_USERNAME = 'license'
export const EE_BACKEND_IMAGE = 'images.starlab.app/enterprise-backend'
export const EE_FRONTEND_IMAGE = 'images.starlab.app/enterprise-frontend'
export const EE_COLLAB_IMAGE = 'images.starlab.app/enterprise-collab'
export const EE_LICENSE_SERVER = 'https://partners.starlab.app'
