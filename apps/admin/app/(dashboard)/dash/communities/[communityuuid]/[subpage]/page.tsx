  ...
  const tabs: DashTabItem[] = [
    {
      ...
      href: getUriWithOrg((params?.orgslug || 'default'), '') + `/dash/communities/${params.communityuuid}/general`,
    ...
    },
    {
      ...
      href: getUriWithOrg((params?.orgslug || 'default'), '') + `/dash/communities/${params.communityuuid}/thumbnail`,
    ...
    },
    {
      ...
      icon: <Users size={16} />,
      href: getUriWithOrg((params?.orgslug || 'default'), '') + `/dash/communities/${params.communityuuid}/access`,
    ...
    },
    {
      ...
      icon: <Link2 size={16} />,
      href: getUriWithOrg((params?.orgslug || 'default'), '') + `/dash/communities/${params.communityuuid}/course`,
    ...
    },
    {
      ...
      icon: <Shield size={16} />,
      href: getUriWithOrg((params?.orgslug || 'default'), '') + `/dash/communities/${params.communityuuid}/moderation`,
