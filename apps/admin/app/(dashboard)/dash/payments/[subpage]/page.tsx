  ...
  const tabs: DashTabItem[] = [
    {
      ...
      label: 'Overview',
      icon: <Users size={16} />,
      href: getUriWithOrg((params?.orgslug || 'default'), '/dash/payments/overview'),
    ...
    },
    {
      ...
      label: 'Offers',
      icon: <Gem size={16} />,
      href: getUriWithOrg((params?.orgslug || 'default'), '/dash/payments/offers'),
    ...
    },
    {
      ...
      icon: <Layers size={16} />,
      href: getUriWithOrg((params?.orgslug || 'default'), '/dash/payments/groups'),
    ...
    },
    {
      ...
      href: getUriWithOrg((params?.orgslug || 'default'), '/dash/payments/configuration'),
      ...
      <div className="ps-4 pe-4 sm:ps-10 sm:pe-10 tracking-tight bg-[#fcfbfc] z-10 nice-shadow flex-shrink-0 relative">
        ...
        <div className="my-2 py-2 flex flex-wrap gap-2 items-end justify-between">
          ...
          <div className="flex items-center space-x-2 pb-1 shrink-0">
            {paymentsEnabled && (
              <Link
                href={getUriWithOrg((params?.orgslug || 'default'), '/store')}
                target="_blank"
