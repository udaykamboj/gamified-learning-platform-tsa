  ...
  const tabs: DashTabItem[] = [
    {
      ...
      label: 'General',
      icon: <Info size={16} />,
      href: getUriWithOrg((params?.orgslug || 'default'), '') + `/dash/boards/${params.boarduuid}/general`,
    ...
    },
    {
      ...
      href: getUriWithOrg((params?.orgslug || 'default'), '') + `/dash/boards/${params.boarduuid}/thumbnail`,
    ...
    },
    {
      ...
      label: 'Access',
      icon: <Globe size={16} />,
      href: getUriWithOrg((params?.orgslug || 'default'), '') + `/dash/boards/${params.boarduuid}/access`,
    ...
    },
    {
      ...
      label: 'Members',
      icon: <Users size={16} />,
      href: getUriWithOrg((params?.orgslug || 'default'), '') + `/dash/boards/${params.boarduuid}/members`,
