  ...
  const tabs: DashTabItem[] = [
    {
      ...
      icon: <Users size={16} />,
      href: getUriWithOrg((params?.orgslug || 'default'), '') + `/dash/users/settings/users`,
    ...
    },
    {
      ...
      href: getUriWithOrg((params?.orgslug || 'default'), '') + `/dash/users/settings/usergroups`,
    ...
    },
    {
      ...
      icon: <Shield size={16} />,
      href: getUriWithOrg((params?.orgslug || 'default'), '') + `/dash/users/settings/roles`,
    ...
    },
    {
      ...
      href: getUriWithOrg((params?.orgslug || 'default'), '') + `/dash/users/settings/signups`,
    ...
    },
    {
      ...
      href: getUriWithOrg((params?.orgslug || 'default'), '') + `/dash/users/settings/add`,
    ...
    },
    {
      ...
      href: getUriWithOrg((params?.orgslug || 'default'), '') + `/dash/users/settings/sign-in`,
    ...
    },
    {
      ...
      href: getUriWithOrg((params?.orgslug || 'default'), '') + `/dash/users/settings/two-factor`,
    ...
    },
    {
      ...
      href: getUriWithOrg((params?.orgslug || 'default'), '') + `/dash/users/settings/audit-logs`,
