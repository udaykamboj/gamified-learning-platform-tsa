...
const SENTRY_DSN = rc.NEXT_PUBLIC_STARLAB_SENTRY_DSN || process.env.NEXT_PUBLIC_STARLAB_SENTRY_DSN;
const STARLAB_ENV = rc.NEXT_PUBLIC_STARLAB_ENV || process.env.NEXT_PUBLIC_STARLAB_ENV || "dev";
