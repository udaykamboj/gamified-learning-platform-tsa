...
The StarLab frontend is a **Next.js 16** application located at `apps/web` in the project. It serves as the primary user interface for learners, instructors, and administrators.
...
When using the StarLab CLI (`starlab dev`), the frontend starts automatically with hot reload enabled.
