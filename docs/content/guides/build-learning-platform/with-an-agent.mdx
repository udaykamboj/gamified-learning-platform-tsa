...
description: Have a coding agent like Claude Code or Cursor build your headless StarLab platform for you, using a ready-made, self-contained specification.
---
...
The spec is written *for the model*: it states the goal, the exact API contract taken from the StarLab codebase, the file layout, the auth rules, and clear acceptance criteria. You supply three facts about your instance and let the agent do the rest.
...
- A running StarLab instance and its API base URL (e.g. `http://localhost:1338/api/v1`).
