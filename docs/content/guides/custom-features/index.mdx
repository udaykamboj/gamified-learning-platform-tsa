...
description: Extend StarLab beyond the official frontend — authenticate with API tokens, create and query content programmatically, and react to events with webhooks.
---
...
The [build guide](/guides/build-learning-platform) showed how to *read* the API as a frontend. This guide is about going further: driving StarLab **programmatically** — creating and managing content from your own scripts and services, and reacting to what happens inside StarLab with **webhooks**.
