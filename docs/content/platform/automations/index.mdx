...
StarLab pushes real-time events to your own systems and to no-code automation tools. Use these to sync learners into your CRM, notify a Slack channel on course completion, trigger certificate printing, or feed any downstream workflow.
...
- **[Zapier](/platform/automations/zapier)** — Official Zapier app with triggers for every StarLab event and actions for enrolling users, completing activities, and looking up learners. Best for no-code workflows into Slack, Google Sheets, HubSpot, and 6,000+ other Zapier apps.
...
1. Something happens inside StarLab (a learner completes a course, a user is invited, an assignment is graded, …).
...
| Run a **StarLab action** from another app (e.g., enroll a user when a HubSpot form is submitted) | **Zapier** |
