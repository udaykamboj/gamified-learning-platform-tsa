...
StarLab supports multiple authentication methods to fit different deployment scenarios.

## Login Methods

- **Email and password** — the default authentication method for every StarLab instance.
