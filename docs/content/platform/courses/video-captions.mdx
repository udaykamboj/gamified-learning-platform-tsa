...
StarLab can automatically generate closed captions (subtitles) for **hosted video** activities and translate them into any languages you choose. Captions are transcribed from the video's audio with AI, so you don't have to write or time them by hand.
