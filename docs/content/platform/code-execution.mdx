...
StarLab integrates with [Judge0](https://judge0.com/) to provide sandboxed code execution inside **Code Playground** blocks on Dynamic Page activities. Students can write and run code directly in the platform, and teachers can define test cases for automatic grading.
