...
Administrators can view an overview of charges, subscriptions, and customers directly from the StarLab admin panel without needing to log into Stripe separately.
