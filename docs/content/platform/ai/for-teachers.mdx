...
The StarLab AI assistant helps teachers create and manage course content more efficiently.
...
The AI assistant is available from the course editor interface. Make sure your instance has a Google Gemini API key configured via `STARLAB_GEMINI_API_KEY` (see [AI Setup](/self-hosting/configuration/ai-setup)) and that AI is enabled for your organization.
