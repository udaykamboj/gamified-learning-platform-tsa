...
- **Auto User Provisioning** — Automatically creates StarLab accounts from IdP profiles.
...
2. Set the `WORKOS_API_KEY` and `WORKOS_CLIENT_ID` environment variables in your StarLab deployment.
